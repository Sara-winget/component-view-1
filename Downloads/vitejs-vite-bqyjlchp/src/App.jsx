...
function App() {
  ...
  return (
    <div style={{display:'flex', height:'auto', width:'auto', justifyContent:'center',alignItems:'center', boxSizing:'border-box',margin:'5%',textAlign:'center',gap:'10%',fontSize:'100%',flexWrap:'wrap'}}>
  {initialPosts.map((item,ind)=><Postcard key={ind} {...item}/>)}
    </div>
  )
}
